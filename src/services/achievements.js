 ...
 *
 * `tcgdexId`   — matches the setId field on card objects from tcgdex.js
 * `fallbackTotals` — card counts used as denominators when the set hasn't been
...
export const ACHIEVEMENT_SETS = [
  {
    ...
    achievements: [
      ...
      },
      {
        ...
        rarity: 'Rare',
        fallbackTotal: 16,
        filter: (cards) => cards.filter((c) => c.rarity === 'Rare'),
      },
      {
        id: 'base-holo',
        title: 'Holo Hunter',
        ...
        rarity: 'Rare Holo',
        fallbackTotal: 16,
        filter: (cards) => cards.filter((c) => c.rarity === 'Rare Holo'),
      },
      {
        id: 'base-full',
  ...
  // ─── Gym Series ──────────────────────────────────────────────────────────
  {
    ...
    achievements: [
      ...
      { id: 'gym1-holo',     title: 'Gym Leader',    description: 'Collect all Rare Holo cards', icon: '✦', rarity: 'Rare Holo', fallbackTotal: 34,  filter: (c) => c.filter((x) => x.rarity === 'Rare Holo') },
  ...
  },
  {
    ...
    achievements: [
      ...
      { id: 'gym2-rare',     title: 'Badge Master',    description: 'Collect all Rare cards',      icon: '★', rarity: 'Rare',      fallbackTotal: 10,  filter: (c) => c.filter((x) => x.rarity === 'Rare') },
      { id: 'gym2-holo',     title: 'Elite Trainer',   description: 'Collect all Rare Holo cards', icon: '✦', rarity: 'Rare Holo', fallbackTotal: 20,  filter: (c) => c.filter((x) => x.rarity === 'Rare Holo') },
  ...
  // ─── Neo Series ───────────────────────────────────────────────────────────
  {
    ...
    achievements: [
      ...
      { id: 'neo1-rare',     title: 'Neo Rare',       description: 'Collect all Rare cards',      icon: '★', rarity: 'Rare',      fallbackTotal: 9,   filter: (c) => c.filter((x) => x.rarity === 'Rare') },
      { id: 'neo1-holo',     title: 'Neo Holo',       description: 'Collect all Rare Holo cards', icon: '✦', rarity: 'Rare Holo', fallbackTotal: 16,  filter: (c) => c.filter((x) => x.rarity === 'Rare Holo') },
  ...
  },
  {
    ...
    achievements: [
      ...
      { id: 'neo2-rare',     title: 'Unown Seeker',   description: 'Collect all Rare cards',      icon: '★', rarity: 'Rare',      fallbackTotal: 29,  filter: (c) => c.filter((x) => x.rarity === 'Rare') },
      { id: 'neo2-holo',     title: 'Neo Holo Finds', description: 'Collect all Rare Holo cards', icon: '✦', rarity: 'Rare Holo', fallbackTotal: 10,  filter: (c) => c.filter((x) => x.rarity === 'Rare Holo') },
  ...
  },
  {
    ...
    achievements: [
      ...
      { id: 'neo3-rare',     title: 'Revelation',     description: 'Collect all Rare cards',      icon: '★', rarity: 'Rare',      fallbackTotal: 21,  filter: (c) => c.filter((x) => x.rarity === 'Rare') },
      { id: 'neo3-holo',     title: 'Revelation Holo', description: 'Collect all Rare Holo cards', icon: '✦', rarity: 'Rare Holo', fallbackTotal: 8,  filter: (c) => c.filter((x) => x.rarity === 'Rare Holo') },
  ...
  },
  {
    ...
    achievements: [
      ...
      { id: 'neo4-rare',     title: 'Dark Rare',      description: 'Collect all Rare cards',      icon: '★', rarity: 'Rare',      fallbackTotal: 21,  filter: (c) => c.filter((x) => x.rarity === 'Rare') },
      { id: 'neo4-holo',     title: 'Dark Holo',      description: 'Collect all Rare Holo cards', icon: '✦', rarity: 'Rare Holo', fallbackTotal: 28,  filter: (c) => c.filter((x) => x.rarity === 'Rare Holo') },
  ...
  // ─── Legendary Collection ────────────────────────────────────────────────
  {
    ...
    achievements: [
      ...
      { id: 'lc-rare',     title: 'Legendary Rare',     description: 'Collect all Rare cards',      icon: '★', rarity: 'Rare',      fallbackTotal: 22,  filter: (c) => c.filter((x) => x.rarity === 'Rare') },
      { id: 'lc-holo',     title: 'Legendary Holo',     description: 'Collect all Rare Holo cards', icon: '✦', rarity: 'Rare Holo', fallbackTotal: 16,  filter: (c) => c.filter((x) => x.rarity === 'Rare Holo') },
  ...
  // ─── e-Card Series ───────────────────────────────────────────────────────
  {
    ...
    achievements: [
      ...
      { id: 'ecard1-rare',     title: 'Expedition Rare',     description: 'Collect all Rare cards',      icon: '★', rarity: 'Rare',      fallbackTotal: 57,  filter: (c) => c.filter((x) => x.rarity === 'Rare') },
      { id: 'ecard1-holo',     title: 'Expedition Holo',     description: 'Collect all Rare Holo cards', icon: '✦', rarity: 'Rare Holo', fallbackTotal: 17,  filter: (c) => c.filter((x) => x.rarity === 'Rare Holo') },
  ...
  },
  {
    ...
    achievements: [
      ...
      { id: 'ecard2-rare',     title: 'Sea Treasure',   description: 'Collect all Rare cards',      icon: '★', rarity: 'Rare',      fallbackTotal: 47,  filter: (c) => c.filter((x) => x.rarity === 'Rare') },
      { id: 'ecard2-holo',     title: 'Aqua Holo',      description: 'Collect all Rare Holo H-cards', icon: '✦', rarity: 'Rare Holo', fallbackTotal: 32, filter: (c) => c.filter((x) => x.rarity === 'Rare Holo') },
  ...
  },
  {
    ...
    achievements: [
      ...
      { id: 'ecard3-rare',     title: 'Sky Rare',       description: 'Collect all Rare cards',      icon: '★', rarity: 'Rare',      fallbackTotal: 40,  filter: (c) => c.filter((x) => x.rarity === 'Rare') },
      { id: 'ecard3-holo',     title: 'Crystal Skies',  description: 'Collect all Rare Holo H-cards', icon: '✦', rarity: 'Rare Holo', fallbackTotal: 32, filter: (c) => c.filter((x) => x.rarity === 'Rare Holo') },
